<div class="hidden sm:block mx-2 md:mx-36 pt-10 font-roboto">
    ...
    <div class='block md:flex items-center my-8 py-2 border-b-2 border-gray-300 w-full md:mx-24'>
        <div class="block w-full md:flex items-center h-full md:h-10 text-3xl mt-4 font-serif">    
            ...
            <button class="flex items-center justify-center sm:justify-start w-full md:w-60 hover:underline hover:decoration-laravel hover:underline-offset-8" id="credit_card">
                House Rentals
            </button>
